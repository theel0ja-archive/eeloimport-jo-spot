...
public class Video extends Result {
    ...
    public Video(final String url, final String title, final String description, final String image_src, final String thunbnail_src) {
        this.url = url;
        this.title = title;
